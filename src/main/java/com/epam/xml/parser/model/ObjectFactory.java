...
public class ObjectFactory {
    ...
    @XmlElementDecl(namespace = "http://com.epam.xml.parser.data/medicines", name = "tablet",
            substitutionHeadNamespace = "http://com.epam.xml.parser.data/medicines",
    ...
    @XmlElementDecl(namespace = "http://com.epam.xml.parser.data/medicines", name = "liquid",
            substitutionHeadNamespace = "http://com.epam.xml.parser.data/medicines",
            substitutionHeadName = "medicine")
